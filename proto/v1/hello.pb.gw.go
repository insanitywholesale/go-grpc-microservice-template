...
var (
	pattern_HelloService_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "hello"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_HelloService_SayCustomHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "hello", "custom_word"}, "", runtime.AssumeColonVerbOpt(true)))
)
